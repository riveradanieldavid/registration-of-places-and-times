...
const TestOne: React.FC = () => {
    ...
    const [currentItem, setCurrentItem] = useState<Item>({ id: 0, name: '', date: '', time: '' });
    ...
    const handleAddItem = () => {
        ...
        if (currentItem.name.trim() === '' || currentItem.date.trim() === '' || currentItem.time.trim() === '') return;
    ...
    const handleItemInputChange = (e: React.ChangeEvent<HTMLInputElement>, id: number) => {
